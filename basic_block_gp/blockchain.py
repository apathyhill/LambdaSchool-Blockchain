...
def mine():
    ...
    proof_valid = blockchain.valid_proof(block_str, proof)
    ...
    if proof_valid:
        ...
        response = {
            ...
            "index": block_new["index"],
            "transactions": block_new["transactions"],
            "proof": block_new["proof"],
            "previous_hash": block_new["previous_hash"],
        }
        return response, 200
    else:
        response = {
